...
locals {
  ...
  name_prefix = "nex-${var.environment}-detector"
...
resource "azurerm_storage_account" "ml" {
  name                     = "nex${var.environment}detectorst${local.name_suffix}"
...
resource "azurerm_container_registry" "ml" {
  ...
  name                = "nex${var.environment}detectorcr${local.name_suffix}"
  location            = azurerm_resource_group.ml.location
  resource_group_name = azurerm_resource_group.ml.name
  sku                 = "Basic"
...
resource "azurerm_machine_learning_workspace" "ml" {
  ...
  friendly_name = "NexaMesh Detector ML Workspace (${var.environment})"
