...
export const manufacturingTimes: ManufacturingTime[] = [
  ...
  // NetSnare Ground Launcher Line
  {
    product: "NetSnare Lite",
    sku: "NSN-LITE-001",
    category: "diyMaker",
    assemblyHours: 1.0,
    testingHours: 0.25,
    ...
    setupTimeHours: 2.0,
    amortizedSetupHours: 0.04,
    totalAmortizedHours: 1.54,
    estimatedLaborCostZar: 259,
    estimatedLaborCostUsd: 14.39,
    notes: "Spring launcher assembly, ground mount, API setup",
  },
  {
    product: "NetSnare Standard",
    sku: "NSN-STD-001",
    category: "prosumer",
    assemblyHours: 2.5,
    testingHours: 0.5,
