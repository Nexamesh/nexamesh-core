---
id: 2025-12-11-strategic-resources-action-tracker
title: "Strategic Resources & Action Tracker - December 11, 2025"
sidebar_label: "Dec 11, 2025 - Strategic Pivot"
...
**Primary Target:** US hardware accelerators, especially SOSV ($500K pre-seed)

**Critical:** Apply to accelerators BEFORE incorporation (maintains eligibility)

**Multi-track Approach:** Pursue simultaneously:

- Accelerators (SOSV, YC, mHUB, Highway1, Rev, Ascent)
- SA grants (TIA, IDC)
- Middle East government innovation hubs
- Adjacent commercial AI projects for cash flow
...
**Middle East Opportunity:** Direct government engagement possible

**Incorporation Timing:** Only needed POST-contract award during bidding

**Advantage:** Innovation hubs actively recruiting foreign startups
...
- Capital-intensive hardware startup in volatile sector
- Legal/regulatory barriers (especially "toy drone" classification)
- SA government support limited and inefficient
- High competition, low success probability

**Upside Justification:**

- Large potential financial returns justify risk
- Novel technical approach (swarm countermeasures)
- Growing global threat landscape creates demand

### 🤝 Partnership Outlook

Alastair Kim expressed interest in advisory role based on:

- Drone AI industry experience (previous startup reached $80M valuation)
...
- ⚠️ **DO NOT INCORPORATE** before applying (maintains eligibility)
- Apply to multiple programs simultaneously
- Incorporate only AFTER securing investment/contracts

---

## 🛠️ Technical Development Tools
...
- Use simulators for early investor pitches (reduces hardware costs)
- Validate AI algorithms in virtual environment first
- Physical prototypes only after proof-of-concept funding
...
- Direct government contract opportunities
- Innovation hub connections to defense agencies
- Incorporation required ONLY after contract award
- Leverage demographic advantages in regional markets
...
- [ ] **Martyn:** Receive VC/accelerator list from Alastair (early next week)
- [ ] **Martyn:** Distribute list to team + begin application research
- [ ] **Yuri:** Refine software documentation for investor-ready demos
- [ ] **Yuri:** Prepare Gazebo simulator demonstrations
- [ ] **Peter:** Define custom drone hardware specifications
- [ ] **All:** Draft initial accelerator application materials

### Week 2-4 (Short-term)

- [ ] Submit applications to 3-5 accelerators (prioritize SOSV)
- [ ] Research South African grants (TIA, IDC)
- [ ] Create simulator-based demo video for pitches
- [ ] Reach out to Middle East innovation hubs (UAE, Abu Dhabi)
- [ ] Explore prison/airport defense use cases in target markets

### Month 2-3 (Medium-term)

- [ ] Complete accelerator interview rounds
- [ ] Develop phased incorporation strategy
- [ ] Identify adjacent commercial AI projects for cash flow
- [ ] Finalize Alastair advisory/partnership arrangement
- [ ] Begin direct government engagement (Middle East)
...
- [UAE Innovation Hub](https://innovationhub.uaeu.ac.ae)
- [ADGM Tech Startup](https://adgm.com/tech-startup)
...
**Next Review:** After receiving Alastair's VC list (early next week)
