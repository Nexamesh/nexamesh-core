...
NexaMesh is a modular, layered defense system designed to provide
...
- **Detection Range**: {PERFORMANCE.DETECTION_RANGE} (standard configuration,
  sensor-dependent)
- **Response Time**: &lt;200ms end-to-end decision latency
  ({PERFORMANCE.RESPONSE_TIME} typical)
...
NexaMesh represents a comprehensive, modular approach to counter-drone
