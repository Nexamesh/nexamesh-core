...
import { MARKET, PERFORMANCE, FUNDING, PHASES } from "@site/src/data/values";

## Path to Global Leadership

NexaMesh's strategic recommendations provide a comprehensive roadmap for
...
- **Middle East and Asia-Pacific**: {MARKET.ASIA_PACIFIC_CAGR} CAGR with less
...
- **Success Rate**: {PERFORMANCE.ACCURACY}
- **Multi-Target Capacity**: {PERFORMANCE.CONCURRENT_TARGETS} simultaneous
  threats
...
- **Response Time**: {PERFORMANCE.RESPONSE_TIME}
- **Success Rate**: {PERFORMANCE.ACCURACY}
- **Multi-Target**: {PERFORMANCE.CONCURRENT_TARGETS} simultaneous threats
...
### Total Funding Needed: {FUNDING.SERIES_A_TARGET}
