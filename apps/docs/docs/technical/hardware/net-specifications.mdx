...
NexaMesh counter-UAS system. Nets provide a non-destructive defeat
...
| ---------------------------- | ------------------------ | ------------------------ | ---------- |
| **Air-to-Air (Interceptor)** | {RKV_M.INTERCEPT_RANGE}+ | Active pursuit/intercept | High       |
...
| --------------------------- | ------ | --------- | ---- | ------------- |
| **{HARDWARE.NET_MATERIAL}** | Medium | Very High | High | Excellent     |
...
For use with {RKV_SYSTEM.RKV_M_NAME} interceptor drone:

| Parameter             | Specification                       | Notes                            |
| --------------------- | ----------------------------------- | -------------------------------- |
| **Deployed Size**     | {NETS.AIR_TO_AIR_SIZE}              | Covers Group 1-2 UAS             |
| **Stowed Size**       | {NETS.AIR_TO_AIR_STOWED}            | Fits net launcher pod            |
| **Material**          | Kevlar/Dyneema blend                | High strength, low weight        |
| **Mesh Size**         | {NETS.AIR_TO_AIR_MESH}              | Captures rotors, prevents escape |
| **Breaking Strength** | {NETS.AIR_TO_AIR_STRENGTH}          | Handles high-speed impact        |
| **Weight**            | {NETS.AIR_TO_AIR_WEIGHT} (net only) | Includes weighted corners        |
| **Corner Weights**    | 4 × 25g tungsten                    | Rapid deployment, stable flight  |
| **Deployment Speed**  | {NETS.AIR_TO_AIR_DEPLOYMENT}        | Full size in 0.2 seconds         |
| **Operating Temp**    | {NETS.AIR_TO_AIR_TEMP_RANGE}        | All-weather capable              |
...
| Parameter             | Specification                    | Notes                          |
| --------------------- | -------------------------------- | ------------------------------ |
| **Deployed Size**     | {NETS.LARGE_FORMAT_SIZE}         | Matches UAVOS standard         |
...
| **Breaking Strength** | {NETS.LARGE_FORMAT_STRENGTH}     | Fixed-wing impact speeds       |
| **Weight**            | 450g                             | Includes deployment mechanism  |
| **Target Speed**      | {NETS.LARGE_FORMAT_TARGET_SPEED} | Relative closure rate          |

### Ground-Launched Net

For Kestrel Mesh consumer product (MSRP: {SKYSNARE.MSRP}):

| Parameter             | Specification              | Notes                                 |
| --------------------- | -------------------------- | ------------------------------------- |
| **Deployed Size**     | {NETS.GROUND_SIZE}         | Consumer drone sizes                  |
| **Launch Range**      | {NETS.GROUND_RANGE}        | Compressed air propulsion             |
| **Material**          | {NETS.GROUND_MATERIAL}     | Cost-effective, reusable              |
| **Mesh Size**         | {NETS.GROUND_MESH}         | Small drone capture                   |
| **Breaking Strength** | 150 kg per strand          | Consumer drone weights                |
| **Weight**            | {NETS.GROUND_WEIGHT}       | Lightweight for portability           |
| **Reloads**           | User-replaceable cartridge | {NETS.GROUND_RELOAD_TIME} reload time |
...
| -------------------- | ----------------------- |
| **Pod Dimensions**   | {NETS.POD_DIMENSIONS}   |
| **Weight (loaded)**  | {NETS.POD_WEIGHT}       |
| **Nets per Pod**     | 1                       |
| **Pods per RKV-M**   | {NETS.PODS_PER_RKV_M}   |
| **Launch Mechanism** | Compressed gas + spring |
| **Launch Velocity**  | {NETS.LAUNCH_VELOCITY}  |
| **Effective Range**  | {NETS.EFFECTIVE_RANGE}  |
...
NexaMesh system. &copy; 2025 NexaMesh. All rights reserved._
