---
id: ethglobal-hackathons
title: ETHGlobal Hackathon Circuit 2026
sidebar_label: ETHGlobal Hackathons
difficulty: beginner
...
- **Prize Pools**: $10K-$100K+ per event
- **Format**: In-person, 48-72 hours
- **Focus**: Ethereum, ZK proofs, DeFi, AI+Crypto
- **Cost**: Free to participate
- **Website**: [ethglobal.com](https://ethglobal.com)
...
4. Explore funding (crypto VCs present)
5. Test experimental features

---

## ETHGlobal New York (Priority Event)
...
- ENS: Naming integration
- Lens Protocol: Social features

---

## ETHPrague (Secondary Priority)
...
4. **Study Bounties**: Review sponsor requirements
...
4. **Target bounties**: Multiple prizes possible
5. **Ship something**: Working > ambitious but broken
...
- Net: Highly positive expected value
...
- [ ] Register for ETHGlobal New York
- [ ] Study ZK proof libraries
- [ ] Build evidence hashing prototype
- [ ] Prepare x402 integration docs
- [ ] Connect with Ethereum community
...
- [ETHGlobal Prizes](https://ethglobal.com/prizes)
