---
id: nato-diana-accelerator
title: NATO DIANA Accelerator Programme
...
- **Phase 1 Funding**: €100,000
- **Phase 2 Funding**: €300,000 (additional)
- **Duration**: 6-month accelerator phases
- **Test Centers**: Access to 200+ facilities across NATO nations
- **Focus**: Energy, AI/ML, Quantum, Autonomy, Space, Biotech
- **Website**: [diana.nato.int](https://www.diana.nato.int)
...
- **Network**: 31 nation defense ministries
...
- [ ] Monitor DIANA website for 2026 challenge calls
- [ ] Prepare NATO-focused pitch deck
- [ ] Document STANAG compatibility
- [ ] Identify preferred test centers
- [ ] Connect with DIANA alumni

---

## External Resources

- [NATO DIANA Official](https://www.diana.nato.int)
- [NATO Innovation Fund](https://www.nfrp.nato.int)
- [VTT Finland](https://www.vttresearch.com)
- [DIANA Accelerator Programme](https://www.diana.nato.int/accelerator-programme.html)
