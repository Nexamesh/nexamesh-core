---
id: nato-diana
title: NATO DIANA (Defence Innovation Accelerator)
sidebar_label: NATO DIANA
difficulty: advanced
...
- **Duration:** 6 months
- **Funding:** Over $100,000 contractual funding
- **Selection Rate:** Top 4% of applicants (2025: 3,680 submissions)
...
1. **Challenge Announcement** - NATO releases challenge themes
2. **Application Window** - Typically 2-3 month window
3. **Initial Review** - Technical and eligibility screening
4. **Deep Dive** - Detailed evaluation
5. **Selection** - Top 4% typically selected
6. **Accelerator** - 6-month program
7. **Demo Day** - Present to NATO officials
...
```
Q1 2026: Establish UK or EU presence
Q2 2026: Build relationships with DIANA partners
Q3 2026: Apply for 2027 DIANA cohort
Q4 2026: Prepare if selected
```
...
- **DIANA:** [diana.nato.int](https://diana.nato.int)
- **UK Accelerator:** Janus Consortium / DASA
- **Regional Offices:** Via NATO website
...
- Network across defense ecosystem
...
- [UK DASA](./uk-dasa) - DIANA UK delivery partner
- [EUDIS](./eudis-accelerator) - EU pathway to DIANA
