---
id: eudis-accelerator
title: EUDIS Business Accelerator
sidebar_label: EUDIS (EU)
...
EUDIS is restricted to companies from **EU Member States** or **Norway**.

Companies must not be controlled by non-associated third country entities.
...
**Recommended:** Explore Irish or Dutch subsidiary for EU program access
...
- [NATO DIANA](./nato-diana) - Similar but broader eligibility
- [UK DASA](./uk-dasa) - UK-specific but post-Brexit accessible
