---
id: uk-dasa
title: UK Defence and Security Accelerator (DASA)
sidebar_label: DASA (UK)
...
The **Defence and Security Accelerator (DASA)** finds and funds exploitable
innovation to support UK defence and security. Part of UK Defence Innovation
(UKDI), DASA provides non-dilutive funding for defense technology development.
...
- **January 13, 2026:** Open Call Cycle 4 closes (final cycle before transition)
- **July 2026:** UKDI Full Operating Capability - new service launches
...
**Eight companies selected for 2026 cohort** from highly competitive process.
...
DASA welcomes applications from international innovators. No UK presence
required, though UK collaboration may strengthen applications.
...
1. **Review** current opportunities on GOV.UK
2. **Contact** Innovation Partner for guidance
3. **Submit** proposal through portal
4. **Assessment** by technical experts
5. **Decision** typically 6-8 weeks
6. **Contract** if successful
...
**Open Call Cycle 4** closes January 13, 2026 - this is the last opportunity
...
4. Submit before January 13, 2026

### July 2026 Opportunity

New UKDI service launches - monitor for announcements about new funding
mechanisms and application processes.
...
- [NATO DIANA](./nato-diana) - DASA-delivered in UK
- [EUDIS](./eudis-accelerator) - European equivalent
