---
id: australia-asca
title: Australia Advanced Strategic Capabilities Accelerator (ASCA)
sidebar_label: ASCA (Australia)
...
ASCA works closely with US Defense Innovation Unit (DIU):

- Exchange positions established (early 2025)
- Bilateral defense collaboration
- Investor and innovator engagement
...
Australia actively seeks international innovation partnerships, particularly
from Five Eyes nations and allied countries. South Africa is not a typical
partner but counter-UAS capability is a priority area.
...
1. **Review** ASCA challenges and priorities
2. **Register** interest through Defence Innovation website
3. **Submit** capability statement
4. **Assessment** by Defence technical teams
5. **Engagement** if capability matches need
6. **Contract** for development/testing
...
- Significant investment in air defense
...
- Similar legal/business framework
- Strong Five Eyes relationships
- Counter-UAS actively sought
...
- **ASCA:** Through Defence Innovation Portal
- **DIU Partnership:** US DIU for referral
...
- [Japan DITI](./japan-diti) - Japanese defense innovation
