...
<ApplicationDocument
  ...
  deadline="2025-12-15T14:00:00-05:00"
  status="draft"
  version="1.0"
  pdfLabel="Print Application"
  pdfDescription="Print full application to PDF via browser"
  ...
  versionHistory={[
    ...
    },
    {
      version: "0.9",
      date: "Dec 10, 2025",
      changes: "Added Canadian content section",
    },
    {
      version: "0.8",
      date: "Dec 5, 2025",
      changes: "Technical specifications review",
    },
  ]}
  checklist={[
    { label: "Organization information", completed: true },
    { label: "Solution description", completed: true },
    { label: "TRL evidence", completed: true },
    { label: "Test plan", completed: true },
    { label: "Team bios", completed: true },
    { label: "Canadian content", completed: true },
    { label: "Safety documentation", completed: true },
    { label: "PriviDox account", completed: false },
    { label: "Legal review", completed: false },
...
**NexaMesh Counter-UAS Defense System**
...
The NexaMesh system is a comprehensive counter-drone solution that
...
The NexaMesh system is designed for seamless integration with military
...
| **Email**           | applications@nexamesh.ai |
| **Phone**           | [To be added]                    |
| **Address**         | [To be added]                    |
...
be made through the official PriviDox platform. © 2026 NexaMesh. All
rights reserved._
